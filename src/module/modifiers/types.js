...
export const SFRPGEffectType = Object.freeze({
    ...
    SPECIFIC_WEAPON_PROPERTY_ATTACKS: "specific-weapon-property-attacks",
    SPECIFIC_WEAPON_CATEGORY_ATTACKS: "specific-weapon-category-attacks",
    ...
    SPECIFIC_WEAPON_PROPERTY_DAMAGE: "specific-weapon-property-damage",
    SPECIFIC_WEAPON_CATEGORY_DAMAGE: "specific-weapon-category-damage",
    AMMO_USAGE_MULTIPLIER: "ammo-usage-multiplier",
    ...
    SPECIFIC_WEAPON_PROPERTY_AMMO_USAGE_MULTIPLIER: "specific-weapon-property-ammo-usage-multiplier",
    SPECIFIC_WEAPON_CATEGORY_AMMO_USAGE_MULTIPLIER: "specific-weapon-category-ammo-usage-multiplier",
